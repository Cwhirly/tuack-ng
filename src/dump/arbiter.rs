...
use crate::prelude::*;
use crate::tuack_lib::dump::Dumper;
...
impl ArbiterDumper {
    ...
    async fn build_filter(
        ...
        prob: &crate::tuack_lib::dump::DumpProblem,
    ) -> Result<Option<Box<dyn crate::tuack_lib::data::AsyncReader>>> {
        ...
        let default_src = gctx().assets_dirs.iter().find_map(|d| {
